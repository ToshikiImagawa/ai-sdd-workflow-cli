...
class TestSearchDocuments:
    def test_index_not_found(self, tmp_path):
        with pytest.raises(ValueError, match="Index not found"):
            search_documents(tmp_path, query="test")
    ...
    def test_text_format(self, tmp_path):
        ...
        result = search_documents(tmp_path, feature_id="auth", output_format="text")
    ...
    def test_json_format(self, tmp_path):
        ...
        result = search_documents(tmp_path, feature_id="auth", output_format="json")
